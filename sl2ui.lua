...
menu.bg.Inventory_Viewer:Remove()
for _, obj in pairs(menu:GetDescendants()) do
   ...
   if obj.Name:lower():find('buildlabel') then
       obj.Text = 'build: <font color="rgb(189, 172, 255)">'..getgenv().build..'</font>'
   end
end
...
local function createWatermark()
   ...
   WaterMarkLabel.Text = "Build: "..getgenv().build
      ...
      function library:CreateLabel(Properties, IsHud)
         ...
         function library:GetTextBounds(Text, Font, Size, Resolution)
            ...
            function library:Create(Class, Properties)
               ...
               draggable(menu.bg)
                  local Cursor = Drawing.new('Triangle');Cursor.Thickness = 1;Cursor.Filled = true;Cursor.Visible = false;Cursor.ZIndex = math.huge;local CursorOutline = Drawing.new('Triangle');CursorOutline.Thickness = 1;CursorOutline.Filled = false;CursorOutline.Color = Color3.new(0, 0, 0);CursorOutline.Visible = false;CursorOutline.ZIndex = math.huge
